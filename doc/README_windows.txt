AudioCoin (ADC) 0.1 BETA

Copyright (c) 2011-2014 Peercoin (PPCoin) Developers
Copyright (c) 2014-2014 AudioCoin (ADC) Developers
...
Intro
-----
AudioCoin is a free open source project derived from Bitcoin, with
...
incoming connections.  AudioCoin works without incoming connections,
but allowing incoming connections helps the AudioCoin network.
