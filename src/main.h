...
static const int64 MAX_MONEY = 10500000000 * COIN; //10,500,000,000 (10.5 billion coins)
...
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 30; // minimum age for coin age (30 days of coin age)
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stake age of full weight (90 days of coin age)
...
static const uint256 hashGenesisBlockTestNet("0x000000006247b1b32e0627453388f262f1058498584a02094d7342f7676cb83a");
...
public:
    ...
    {
        // AudioCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // AudioCoin: get transaction coin age
...
public:
    ...
    // AudioCoin: block signature - signed by coin base txout[0]'s owner
    ...
    // AudioCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // AudioCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // AudioCoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // AudioCoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // AudioCoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // AudioCoin: block index flags
    enum  
    {
