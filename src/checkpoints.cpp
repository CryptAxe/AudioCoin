...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 19080, uint256("0x0")) // Need to be set in the future...
        ( 30583, uint256("0x0"))
        ( 99999, uint256("0x0"))
        ;
    ...
    // AudioCoin: synchronized checkpoint (centrally broadcasted)
    ...
    // AudioCoin: get last synchronized checkpoint
    ...
    // AudioCoin: only descendant of current sync-checkpoint is allowed
    ...
    // AudioCoin: reset synchronized checkpoint to last hardened checkpoint
...
// AudioCoin: sync-checkpoint master key
...
// AudioCoin: verify signature of sync-checkpoint message
...
// AudioCoin: process synchronized checkpoint
