 ...
 * The AudioCoin Developers 2014-2014
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("AudioCoin (ADC) Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    toggleHideAction = new QAction(QIcon(":/icons/ppcoin"), tr("Show/Hide &AudioCoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the AudioCoin window"));
