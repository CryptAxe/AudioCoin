        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start AudioCoin on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start AudioCoin after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the AudioCoin client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show AudioCoin addresses in the transaction list"));
